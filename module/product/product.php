...
<div id="product">
    <div id="product-head" class="row">
        ...
        <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul>
                <li><span>Vật liệu:</span><?php echo $row['prd_material'] ?></li>
                <li><span>Kích thước:</span><?php echo $row['prd_size'] ?></li>
                <li><span>Bộ sưu tập:</span><?php echo $row['prd_collection'] ?></li>
                <li><span>Bảo hành</span><?php echo $row['prd_warranty'] ?></li>
                <li id="price">Giá Bán: (chưa bao gồm VAT)</li>
                <li id="price-number"><?php echo number_format($row['prd_price']) ?></li>
                <li id="status" class="text-danger"><span>Tình trạng:</span>
