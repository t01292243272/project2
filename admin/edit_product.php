...
if (isset($_POST['sbm'])) {
    ...
    $sql_update = "UPDATE product 
                SET prd_name=('$prd_name'), prd_price=('$prd_price'), prd_warranty=('$prd_warranty'), prd_material=('$prd_material'), prd_size=('$prd_size'), prd_collection=('$prd_collection'), prd_image=('$prd_image'), prd_status=('$prd_status'), cat_id=('$cat_id'), prd_details=('$prd_details'), prd_featured=('$prd_featured') WHERE prd_id=$prd_id";
                    ...
                    <div class="col-md-6">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="prd_material" required value="<?php echo $row['prd_material']; ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Kích thước</label>
                                <input type="text" name="prd_size" required value="<?php echo $row['prd_size']; ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Bộ sưu tập</label>
                                <input type="text" name="prd_collection" required value="<?php echo $row['prd_collection'];?>" type="text" class="form-control">
                            </div>
